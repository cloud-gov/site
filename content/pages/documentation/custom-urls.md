...
This is technical documentation about how custom domains work on Pages. It is not required reading to use Pages and only provided for background; instructions for our partners are [here](/pages/documentation/custom-domains/).
...
1. The Pages team uses the [cloud.gov CloudFront broker](/docs/services/cdn-route/) to begin set up for a distribution for a given URL.
