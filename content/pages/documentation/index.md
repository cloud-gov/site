...
![Pages Sitelist Screenshot]({{ '/img/pages/federalist-sitelist.png' }})
...
![Pages Sitelist Screenshot]({{ '/img/pages/federalist-makesite2.png' }})
...
![Pages Settings Screenshot]({{ '/img/pages/pages-site-settings-branch-config.png' }})
