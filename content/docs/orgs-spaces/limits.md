...
You can request an increase in number of [application routes](/docs/management/custom-domains) or [service instances](/docs/deployment/managed-services) with no cost impact. Increasing or decreasing org memory quota changes your maximum usage costs.

### View org quota details

To view your [org quota](/docs/pricing/quotas):
