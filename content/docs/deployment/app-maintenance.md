...
For details, see the [cloud.gov System Security Plan (SSP)]({{ site.baseurl }}/docs/overview/fedramp-tracker#how-you-can-use-this-p-ato) control descriptions in the SI and CM families, including SI-2, CM-2, CM-2 (2), and CM-6 (1).
