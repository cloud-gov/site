...
For new services, please use the [external domain service]({{ site.baseurl }}/docs/services/external-domain-service).
...
If you need CDN caching for your applications, use the [CDN service]({{ site.baseurl }}/docs/services/cdn-route) instead.
...
*Not available in [sandbox spaces]({{ site.baseurl }}/docs/pricing/free-limited-sandbox#sandbox-limitations) or [prototyping orgs]({{ site.baseurl }}/_pages/pricing#limitations).*
