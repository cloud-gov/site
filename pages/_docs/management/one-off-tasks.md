...
--- | ---
Inspect an app instance to figure out what's wrong | [`cf ssh`]({{ site.baseurl }}/_docs/management/using-ssh)
Work with one of your service instances | [`cf ssh` with port forwarding]({{ site.baseurl }}/_docs/management/using-ssh)
...
```
1. If needed, use [`cf ssh`]({{ site.baseurl }}/_docs/management/using-ssh) to collect any artifacts.
