...
First, [set up your command line interface (CLI)]({{ site.baseurl }}/_docs/getting-started/setup) (if you haven't already).
...
If you have a federal email address, when you log in for the first time, cloud.gov will start automatically creating a [sandbox space]({{ site.baseurl }}/_docs/pricing/free-limited-sandbox) for you. You might need to wait up to 5 minutes before it becomes available.
...
Next, check out [Concepts]({{ site.baseurl }}/_docs/getting-started/concepts) for an overview of cloud.gov terms and architecture.

Then, head over to [**deployment instructions and architecture principles**]({{ site.baseurl }}/_docs/deployment/deployment) for an introduction to deploying your own applications on cloud.gov.
