...
If you have [access to cloud.gov]({{ site.baseurl }}/_docs/getting-started/accounts), here's how to log in.
...
Now [try your first deploy of a test application]({{ site.baseurl }}/_docs/getting-started/your-first-deploy).
